...
public class StationDTO {
    ...
    @NotNull
    private Integer distanceBetweenDestination;
    ...
    public Integer getDistanceBetweenDestination() {
        return this.distanceBetweenDestination;
    }

    public void setDistanceBetweenDestination(Integer distanceBetweenDestination) {
    ...
    public String toString() {
        return "{" +
                ...
                ", distanceBetweenDestination='" + getDistanceBetweenDestination() + "'" +
                "}";
    }
